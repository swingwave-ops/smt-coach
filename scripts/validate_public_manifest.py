...
PUBLIC_FILES = (
    ...
    "docs/ko/input-schema.md",
    "docs/ko/install-linux-x86_64.md",
    "docs/ko/install-macos.md",
    "docs/ko/privacy.md",
    "docs/ko/provenance.md",
    "docs/ko/public-distribution.md",
    "docs/ko/release-checklist.md",
    "docs/ko/threat-model.md",
    "docs/ko/verification-handoff.md",
